...
set CLASSPATH=%APP_HOME%\lib\MyProject.jar;%APP_HOME%\lib\joda-time-2.2.jar


@rem Execute MyProject
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %MY_PROJECT_OPTS%  -classpath "%CLASSPATH%" hello.HelloWorld %*
